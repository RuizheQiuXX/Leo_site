...
export const email = 'linsong.hao@duke.edu'
export const githubUsername = 'HenryRorschach'

// about page
export const aboutMeHeadline = 'Who Are You and Why Should I Care?'
export const aboutParagraphs = [
  "Hey there! I’m Linsong Hao — born in China, trained in tech in NYC, and now diving into the world of business analytics at Duke University. My journey bridges the gap between code and strategy, with a B.A. from NYU and current grad studies at Fuqua.",
